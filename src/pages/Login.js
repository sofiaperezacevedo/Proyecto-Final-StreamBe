...
function Login() {
  ...
  return (
    <div className="carrito-container" style={{ minHeight: "100vh", backgroundColor: "#fafafa" }}>
      <header>
        <a href="/">
        ...
        <nav>
          ...
          <a href="https://www.facebook.com/profile.php?id=61574672454293" target="_blank" rel="noreferrer">Facebook</a>
        ...
        {modo === "login" ? (
          <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: "15px" }}>
            ...
            <button
              type="submit"
              style={{
                backgroundColor: "#DA968B", // tu rosa original
                color: "#fff",
                border: "none",
                padding: "10px",
                borderRadius: "5px",
            ...
            <a href="#" style={{ marginTop: "10px", color: "#7E57C2", fontSize: "14px" }}>
